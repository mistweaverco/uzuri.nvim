---@class uzuri.notify.Notification
---@field id integer
---@field level string
...
---@field on_open fun(win: number, record: uzuri.notify.Record) | nil
---@field on_close fun(win: number, record: uzuri.notify.Record) | nil
---@field render fun(buf: integer, notification: uzuri.notify.Notification, highlights: table<string, string>)
...
---@param opts uzuri.notify.Options
