local Notification = require("uzuri.notify.service.notification")
local NotificationBuf = require("uzuri.notify.service.buffer")
local NotificationService = require("uzuri.notify.service")
local WindowAnimator = require("uzuri.notify.windows")
local config = require("uzuri.notify.config")
local stage_util = require("uzuri.notify.stages.util")
local stages = require("uzuri.notify.stages")
...
---@param n1 uzuri.notify.Notification
---@param n2 uzuri.notify.Notification
---@return boolean
...
---@param global_config uzuri.notify.Config
return function(user_config, inherit, global_config)
  ---@type uzuri.notify.Notification[]
  local notifications = {}
  ...
  local function get_render(render)
    ...
    return require("uzuri.notify.render")[render]
  end

  ---@param notif uzuri.notify.Notification
  ---@return uzuri.notify.Notification?
