---@tag uzuri.notify.config

local Config = {}
local util = require("uzuri.notify.util")

require("uzuri.notify.config.highlights")
...
local default_config = {
  ...
  background_colour = "UzuriNotifyBackground",
  on_open = nil,
  on_close = nil,
  minimum_width = 50,
  fps = 30,
